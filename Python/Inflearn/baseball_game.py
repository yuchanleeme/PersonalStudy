...
def is_duplicated_number(three_digit):
    ...
    temp_s =[]
    for str in three_digit:
        temp_s.append(str)
    if len(set(temp_s)) == 1 or len(set(temp_s)) == 2 :
        result = True
    else :
        result = False
    # ==================================
...
def get_not_duplicated_three_digit_number():
    ...
    random_number = 0
    while True :
        if is_duplicated_number(str(random_number)) :
...
def main():
    ...
    while rs_trigger is True :
        ...
        gm_trigger = True
        yn_trigger = True
        while gm_trigger is True :
            temp_r = []
            user_input = input('Input guess number : ')
            if is_validated_number(user_input):
                temp_r.extend(get_strikes_or_ball(user_input,random_number))
                print("Strikes :",temp_r[0],"Balls",temp_r[1])
                if temp_r[0] is 3 :
                    while yn_trigger is True:
...
if __name__ == "__main__":
    main()
    # a = get_not_duplicated_three_digit_number()
    # print(a)
    # print(is_duplicated_number("122"))
    # print(get_strikes_or_ball("471", "472"))
    # print(is_yes("yeS"))
